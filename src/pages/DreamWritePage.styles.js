...
export const DreamTitleWrap = styled.div`
  position: relative;
  padding-top: 20px;
  padding-left: 25px;
  padding-right: 25px;
...
export const DreamTitleText = styled.input`
  font-family: "tj400";
  ...
  height: 40px;
`;
export const DreamTitleTextNum = styled.span`
  font-family: "tj400";
  position: absolute;
  text-align: right;
  top: 115px;
...
`;
export const DreamEmojiWrap = styled.div`
  padding: 40px 20px 0px 20px;
  min-height: 500px;
`;
export const DreamEmojiTitle = styled.h2`
  margin-bottom: 10px;
`;
export const DreamEmojiBox = styled.ul`
  border: ${({ error }) => (error ? "2px" : "1px")} solid
...
`;
export const DreamEmojiList = styled.li`
